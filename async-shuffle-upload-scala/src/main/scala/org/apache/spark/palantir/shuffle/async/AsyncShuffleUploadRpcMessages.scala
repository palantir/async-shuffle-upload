...
case class RegisterMergedMapOutput(mapOutputs: Seq[MapOutputId], mergeId: Long) extends AsyncShuffleUploadRpcMessage

case class GetMapOutputMergeId(mapOutputId: MapOutputId) extends AsyncShuffleUploadRpcMessage

case class BlacklistExecutor(blockManagerId: BlockManagerId) extends AsyncShuffleUploadRpcMessage

case object GetBlacklistedExecutors extends AsyncShuffleUploadRpcMessage
